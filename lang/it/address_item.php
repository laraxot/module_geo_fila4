...
return [
    'fields' => [
        ...
        'locality' => [
            ...
            'helper_text' => '',
            'description' => 'Sotto-divisione della città/comune (es. frazione, zona periferica, quartiere).',
        ],
        'administrative_area_level_3' => [
            ...
            'helper_text' => '',
            'description' => 'Comune/amministrazione locale (es. Milano, Firenze).',
        ],
        'administrative_area_level_2' => [
            ...
            'helper_text' => '',
            'description' => 'Provincia amministrativa (es. MI, FI).',
        ],
        ...
        'country' => [
            ...
            'help' => 'Paese/Stato in cui si trova l\'indirizzo.',
            'helper_text' => '',
            'description' => 'Nome dello Stato (es. Italia, Francia).',
        ],
        'postal_code' => [
            'label' => 'CAP',
